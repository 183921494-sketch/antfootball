...
CREATE POLICY "Service role full access on players" ON public.players FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on matches" ON public.matches FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on odds" ON public.odds FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on analysis_reports" ON public.analysis_reports FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on intelligence" ON public.intelligence FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on commissions" ON public.commissions FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on system_config" ON public.system_config FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role full access on admins" ON public.admins FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role full access on partners" ON public.partners FOR ALL USING (true) WITH CHECK (true);
