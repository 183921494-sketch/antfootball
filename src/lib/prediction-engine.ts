...
const ABBREV_CN_MAP: Record<string, string> = {
  ...
  BIH: '波黑', SVK: '斯洛伐克', SVN: '斯洛文尼亚', MKD: '北马其顿',
  MNE: '黑山', ALB: '阿尔巴尼亚', BLR: '白俄罗斯', MDL: '摩尔多瓦',
  LVA: '拉脱维亚', LTU: '立陶宛', EST: '爱沙尼亚', FIN: '芬兰',
  LUX: '卢森堡', BUL: '保加利亚', ROU: '罗马尼亚', HUN: '匈牙利',
  CYP: '塞浦路斯', GRC: '希腊',
  ZIM: '津巴布韦', ANG: '安哥拉', SYR: '叙利亚', JOR: '约旦',
  LBN: '黎巴嫩', PLE: '巴勒斯坦', OMA: '阿曼', BHR: '巴林',
  KUW: '科威特', YEM: '也门',
  TJK: '塔吉克斯坦', TKM: '土库曼斯坦',
  MNG: '蒙古', NPL: '尼泊尔', IND: '印度', PAK: '巴基斯坦',
  BAN: '孟加拉国', SRI: '斯里兰卡', MYA: '缅甸', THA: '泰国',
  VIE: '越南', LAO: '老挝', CAM: '柬埔寨', MAS: '马来西亚',
  INA: '印度尼西亚', PHI: '菲律宾', SIN: '新加坡',
  TRI: '特立尼达和多巴哥', HON: '洪都拉斯', SLV: '萨尔瓦多',
  GTM: '危地马拉', NCA: '尼加拉瓜', PUR: '波多黎各',
  DOM: '多米尼加', CUB: '古巴', GLP: '瓜德罗普',
  SUR: '苏里南', GUY: '圭亚那', BOL: '玻利维亚', PRY: '巴拉圭',
  PAR: '巴拉圭',
  CPV: '佛得角',
  CUW: '库拉索',
  KEN: '肯尼亚',
